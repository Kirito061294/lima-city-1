<link rel="shortcut icon" href="https://mwiese.de/include/45454.ico" type="image/x-icon"/>
		...
		<meta property="og:url" content="https://www.mwiese.de/" />
    </head>
	<body>
        <header>
            <section>
                <nav>
                    ...
                    <ul class="kopf">
                        ...
                        <li class="expandable_li">
						    ...
						    <ul class="dropdown"><li><a href="https://mwiese.de/Technik/OS/OS.php">Betriebssysteme</a></li><li><a href="https://mwiese.de/Technik/Netzwerk/Netzwerk.php">Internet/Netzwerk</a></li><li><a href="https://mwiese.de/Technik/Interessantes.php">Interessantes</a></li></ul>
						</li>
                        <li class="expandable_li">
						    <input type="checkbox" id="subdomains_checkbox">
							<label for="subdomains_checkbox">Unterseiten</label>
						    <ul class="dropdown"><li><a href="https://mwiese.de/Glaube/Glaube.php" target="_blank">Glaubensthemen</a></li><li><a href="https://pc.mwiese.de" target="_blank">Mein Hobby</a></li><li><a href="https://mwiese.de/Themen/Themen.php" target="_blank">Spezielle Themen</a></li></ul>
						</li>
